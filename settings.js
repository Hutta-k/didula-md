...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~1JAzEYBa#sl_-LDKXeekZC4vJsg8-K0rvnlvEylvkQX1n2Pp0tbI' : process.env.SESSION_ID,
...
WELCOME: process.env.WELCOME || 'false',
    SUDO: process.env.SUDO === undefined ? '48729758384' : process.env.SUDO,
